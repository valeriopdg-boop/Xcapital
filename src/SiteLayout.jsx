    ...
    <dialog className="contact-dialog" ref={dialogRef} onClose={close}>
      ...
      {sent ? (
        ...
        <form onSubmit={(event) => { event.preventDefault(); setSent(true); }}>
          ...
          <p>I dati restano nel browser e non vengono trasmessi a XCapital.</p>
...
function DesktopNavigation({ onContact }) {
...
export function SiteLayout({ children }) {
  ...
  const footer = approvedContent.footer ?? { brand: "XCAPITAL", links: [], legalLinks: [], locales: [], copyright: "© 2026 XCapital" };
  ...
  return (
    <>
      ...
      <header className="site-header">
        ...
        {mobile ? <MobileNavigation open={menuOpen} onNavigate={() => setMenuOpen(false)} /> : <DesktopNavigation onContact={() => setDialogOpen(true)} />}
      </header>
